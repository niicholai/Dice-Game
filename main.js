...
function diceRoll() {
  ...
  //winner results text
  if (roll1 > roll2) {
    document.querySelector("h1").innerHTML = "<img src='images/flagLeft.png'></img> Player 1 wins!";
  } else if (roll1 < roll2) {
    document.querySelector("h1").innerHTML = "Player 2 wins! <img src='images/flagRight.png'></img>";
  } else {
